...
let selectedExercise: Ref<string | null> = ref(null)
const exerciseDescription = computed(() => exerciseDescriptions[Number(selectedExercise.value)])  
...
<template>
  ...
  <section id="workout-card">
    ...
    <div class="card workout-btns">
      <button @click="handleSaveWorkout && handleSaveWorkout()">
        Save & Exit <i class="fa-solid fa-save"></i>
      </button>
      <button
        @click="handleSaveWorkout && handleSaveWorkout()"
