...
<template>
  <MainLayout>
    <!-- PAGE 1 -->
    <WelcomePage v-if="selectedDisplay == 1" :handleChangeDisplay="handleChangeDisplay" />
    <!-- PAGE 2 -->
    <DashboardPage v-if="selectedDisplay == 2" :handleResetPlan="handleResetPlan" :firstIncompleteWorkoutIndex="firstIncompleteWorkoutIndex" :handleSelectWorkout="handleSelectWorkout" />
    <!-- PAGE 3 -->
    <WorkoutPage v-if="workoutProgram?.[selectedWorkout]" :handleSaveWorkout="handleSaveWorkout" :isWorkoutComplete="isWorkoutComplete" :data="data" :selectedWorkout="selectedWorkout" />
  </MainLayout>
</template>
